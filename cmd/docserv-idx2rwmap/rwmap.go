...
//
//	LC_ALL=C sort output.* > /srv/docserv/rwmap.txt
//
...
var (
	indexPaths = flag.String("index",
		...
		"List of comma separated path to an auxserver index files generated by rpm2docserv")
...
func main() {
	...
	log.Printf("Loaded %d index entries from %q", len(idx.Entries), *indexPaths)
